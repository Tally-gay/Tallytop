...
const releases = await fetch("https://api.github.com/repos/Equicord/Tallytop/releases", {
    headers: {
...
const metaInfo = await (async () => {
    for (const release of releases) {
        const metaAsset = release.assets.find((a: any) => a.name === "org.equicord.tallytop.metainfo.xml");
...
await fs.writeFile("./dist/org.equicord.tallytop.metainfo.xml", output, "utf-8");
console.log("Updated meta information written to ./dist/org.equicord.tallytop.metainfo.xml");
