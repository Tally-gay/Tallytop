...
export const DATA_DIR =
    process.env.EQUICORD_USER_DATA_DIR || (PORTABLE ? join(tallytopDir, "Data") : join(app.getPath("userData")));
...
export const USER_AGENT = `Tallytop/${app.getVersion()} (https://github.com/tally-gay/Tallytop)`;
