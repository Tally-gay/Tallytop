...
export default ErrorBoundary.wrap(
    ...
    {
        message:
            "Failed to render the Tallytop Settings tab. If this issue persists, try to right click the Tallytop tray icon, then click 'Repair Equicord'. And make sure your Tallytop is up to date."
    }
);
